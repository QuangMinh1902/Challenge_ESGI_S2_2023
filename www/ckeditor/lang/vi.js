...
CKEDITOR.lang["vi"] = {
  ...
  common: {
    ...
    confirmCancel:
      "Một vài tùy Choose đã bị thay đổi. Bạn có chắc chắn muốn đóng hộp thoại?",
    options: "Tùy Choose",
    target: "Đích đến",
  ...
  button: { selectedLabel: "%1 (Đã Choose)" },
  colorbutton: {
    auto: "Tự động",
  ...
  colordialog: {
    clear: "Xóa bỏ",
    highlight: "Màu Choose",
    options: "Tùy Choose màu",
    selected: "Màu đã Choose",
    title: "Choose màu",
  },
  templates: {
    button: "Mẫu dựng sẵn",
    ...
    options: "Tùy Choose mẫu dựng sẵn",
    selectPromptMsg:
      "Hãy Choose mẫu dựng sẵn để mở trong trình biên tập<br>(nội dung hiện tại sẽ bị mất):",
    title: "Nội dung Mẫu dựng sẵn",
  },
  contextmenu: { options: "Tùy Choose menu bổ xung" },
  div: {
  ...
  forms: {
    ...
    checkboxAndRadio: {
      ...
      radioTitle: "Thuộc tính nút Choose",
      value: "Giá trị",
      selected: "Được Choose",
    },
    form: {
    ...
    select: {
      title: "Thuộc tính ô Choose",
      selectInfo: "Thông tin",
      opAvail: "Các tùy Choose có thể sử dụng",
      value: "Giá trị",
      size: "Kích cỡ",
      lines: "dòng",
      chkMulti: "Cho phép Choose nhiều",
      opText: "Văn bản",
      opValue: "Giá trị",
      btnAdd: "Thêm",
      btnModify: "Thay đổi",
      btnUp: "Lên",
      btnDown: "Xuống",
      btnSetValue: "Giá trị được Choose",
      btnDelete: "Nút xoá",
    },
    textarea: {
  ...
  image: {
    ...
    button2Img: "Bạn có muốn chuyển nút bấm bằng ảnh được Choose thành ảnh?",
    hSpace: "Khoảng đệm ngang",
    img2Button:
      "Bạn có muốn chuyển đổi ảnh được Choose thành nút bấm bằng ảnh?",
  ...
  smiley: {
    options: "Tùy Choose hình  biểu lộ cảm xúc",
  ...
  link: {
    ...
    rel: "Quan hệ",
    selectAnchor: "Choose một điểm neo",
    styles: "Kiểu (style)",
  ...
  save: { toolbar: "Lưu" },
  selectall: { toolbar: "Choose tất cả" },
  showblocks: { toolbar: "Hiển thị các khối" },
  sourcearea: { toolbar: "Mã HTML" },
  specialchar: {
    options: "Tùy Choose các ký tự đặc biệt",
    title: "Hãy Choose ký tự đặc biệt",
