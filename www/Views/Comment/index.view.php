                        ...
                        <tbody>
                            ...
                            ?>
                                <tr id="tr_<?php echo $value['id']; ?>">
                                    ...
                                    <td><?php $date = explode(' ', $value['date_inserted']);
                                        echo $date[0]; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-info has-ripple" data-bs-toggle="modal" data-bs-target="#popup_reply" onclick="getReply('<?php echo $value['id']; ?>','<?php echo trim($value['title'], ' '); ?>','<?php echo trim($value['content'], ' '); ?>','<?php echo trim($value['reply'], ' '); ?>')">
                                            <i class="feather icon-edit"></i>
                                            Reply
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-danger has-ripple" data-bs-toggle="modal" data-bs-target="#popup_delete" onclick="getName('<?php echo $value['id']; ?>','<?php echo $value['title']; ?>')">
